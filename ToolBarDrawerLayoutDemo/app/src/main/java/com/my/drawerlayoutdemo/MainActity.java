package com.my.drawerlayoutdemo;
...
public class MainActity extends AppCompatActivity {
  ...
  /*  private ImageView ivRunningMan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   mAnimationDrawable = (AnimationDrawable) getResources().getDrawable(R.drawable.runningmain);
        ivRunningMan.setBackground(mAnimationDrawable);*/
